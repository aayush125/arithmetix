...
@Composable
fun KeypadKey(text: String, fontSize: TextUnit, onClick: () -> Unit, modifier: Modifier = Modifier) {
...
fun KeypadKeyPreview() {
    KeypadKey(text = "8", fontSize = 50.sp, onClick = {}, modifier = Modifier.size(80.dp))
}