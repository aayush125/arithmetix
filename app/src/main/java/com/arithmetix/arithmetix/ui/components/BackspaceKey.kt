...
@Composable
fun BackspaceKey(modifier: Modifier, keySize: Dp, onClick: () -> Unit, index: Int, enabled: Boolean = true) {
    ...
    Box(
        ...
        Box(
            modifier = Modifier
                ...
                .background(color = if (enabled) animatedBackgroundColor else Color(0xffdb9a9a), shape = CircleShape),
...
fun BackspaceKeyPreview() {
    BackspaceKey(modifier = Modifier.padding(15.dp), 70.dp, {}, 0)
}